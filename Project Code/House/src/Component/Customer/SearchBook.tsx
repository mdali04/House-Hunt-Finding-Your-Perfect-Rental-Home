...
const SearchRentHouse = () => {
    ...
    useEffect(() => {
        dispatch(searchHousess(location, minPrice, maxPrice, type, facility) as any);
    }, [location, minPrice, maxPrice, type, facility, dispatch]);

    const houses = useSelector((state: any) => state.Customer.search); 
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex space-x-2">
                            ...
                            <input
                                ...
                                className="w-full p-2 border border-gray-400  rounded-lg focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 transition duration-300"
                            />
                        </div>
                    </div>
