...
const AddRentHouse = () => {
   ...
   const {id} = useParams();
    ...
    const handleSubmit = (e:any) => {
        ...
        images && Array.from(images).map((image:any) => data.append('images', image)); 
        data.append('images', images as any);  
        ...
        if(id){
            dispatch(UpdateHouse(data,id) as any);
        }else{
            dispatch(AddHouse(data,ids._id) as any);
        }
    };
