...
const RentHouseGrid: React.FC = () => {
    ...
    useEffect(() => {
        dispatch(GetHouse(rentals._id) as any);
    }, [dispatch]);


     
    const housess = useSelector((state:any) => state.Rental.houses);
    ...
    const handleDelete = (id: string) => {
        dispatch(DeleteHouse(id) as any);
    };
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {housess?.map((house:any,index:any) => (
