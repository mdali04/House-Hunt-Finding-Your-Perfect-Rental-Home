...
const Homepage = () => {
  ...
  return (
    <div>
      ...
      {/* Sidebar */}
      <div className={`" hidden md:block w-64 bg-gradient-to-r from-purple-50 to-blue-50 shadow-md" ${showSidebar?"":"w-2"}`}>
        {showSidebar?<div>
        <div className=" flex ">
          <img
            src="/houe1.png"
        ...
        <ul className="flex flex-col p-2 gap-2 mt-6">
          ...
          <li>
            <button onClick={handleLogout} className=" hover:bg-blue-500 text-black font-serif w-full text-left h-12 rounded-md p-3 flex gap-3">
        ...
        <ul className="flex flex-col w-20  p-2 gap-2 mt-6" >
          <li>
            <NavLink
              to="/rents/dashboard"
              className={({ isActive }) =>
          ...
          <li>
            <button onClick={handleLogout}   className=" hover:bg-blue-500 text-white w-full text-left h-12 rounded-md p-3 flex gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"   fill="currentColor"><path d="M806-440H320v-80h486l-62-62 56-58 160 160-160 160-56-58 62-62ZM600-600v-160H200v560h400v-160h80v160q0 33-23.5 56.5T600-120H200q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h400q33 0 56.5 23.5T680-760v160h-80Z"/></svg>
            </button >
          </li>
        </ul>
      ...
      <div className="flex-1 flex flex-col sticky z-50">
        <nav className="bg-gradient-to-r from-teal-100 via-lime-100 to-sky-100 shadow-md h-16 flex items-center justify-between px-6">
          <div className=" flex space-x-2" onClick={()=>setShowSidebar(!showSidebar)}>
            ...
            <span className="text-lg font-semibold">Rental Panel</span>
          </div>
      ...
      <div className="md:hidden fixed inset-x-0 bottom-0 bg-gradient-to-b from-teal-200 via-lime-300 to-sky-300 text-white flex justify-around items-center h-16 shadow-md z-50">
                ...
                >
                    ...
                    <span className="text-sm">viewhouse</span>
                </NavLink>
                <NavLink
                    to="/rents/booking"
                    className={({ isActive }) =>
                ...
                <button onClick={handleLogout}  className="hover:text-blue-400 flex flex-col items-center">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        height="24px"
                        viewBox="0 -960 960 960"
